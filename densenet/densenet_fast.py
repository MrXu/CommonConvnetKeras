...
def create_densenet_fast(nb_classes, img_dim, depth=40, nb_dense_block=3, growth_rate=12, nb_filter=16, dropout_rate=None,
    ...
    plot_model_cwd(densenet, visual_path, "DenseNet-fast-%d-%d.png" % (depth, growth_rate))
    densenet.summary()
