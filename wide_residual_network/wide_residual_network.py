...
# default tensorflow format
def get_wrn_16_8_complete(nb_class=10, input_dim=(224, 224, 3)):
    wrn_16_8 = create_wide_residual_network(input_dim, nb_classes=nb_class, N=2, k=8, dropout=0.25)
    wrn_16_8.summary()

    plot_model_cwd(wrn_16_8,visual_path, "wrn_16_8_complete.png")
